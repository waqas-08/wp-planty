		...
		return [
			...
			'yoga' => [
				'v1' => [
					...
					'plugins' => '{"contact-form-7":'. $is_cf7_active .'}',
					'tags' => 'free personal trainer gym fitness yoga stydio yoga trainer exercises workout blog cardio strength training weightlifting crossfit hiit bodyweight exercises muscle building bodybuilding powerlifting',
					'theme-builder' => false,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
			...
			'home-care' => [
				'v1' => [
					...
					'plugins' => '{}',
					'tags' => 'homecare medication management medical elderly home assisted living facility elder home elder care old age home elders care retirement home health healthcare senior living old care senior living senior care services retirement home eldery care hospital nurse retire',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => true,
					'price' => $is_pro_active ? 'free' : 'free',
			...
			'portfolio' => [
				'v1' => [
					...
					'plugins' => '{"contact-form-7":'. $is_cf7_active .'}',
					'tags' => 'free portfolio personal cv designer ux artist artwork personal resume photographer grid agency clean creative freelanceer vcard',
					'theme-builder' => false,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
			   ...
			   'v2' => [
					...
					'plugins' => '{}',
					'tags' => 'free portfolio personal cv designer ux artist artwork personal resume photographer grid one page onepage agency clean creative freelanceer vcard',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
			...
			'digitalagency' => [
				...
				'v3' => [
					...
					'plugins' => '{}',
					'tags' => 'free digital agency company corporate digital services office agency web marketing slider',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
			...
			'construction' => [
				'v1' => [
					...
					'plugins' => '{}',
					'tags' => 'free construction architecture company interior office real estate',
					'theme-builder' => false,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
				...
				'v3' => [
					...
					'tags' => 'construction architecture company building consultation real estate',
					'theme-builder' => true,
					'woo-builder' => true,
					'off-canvas' => true,
					'price' => $is_pro_active ? 'free' : 'pro',
